/*
Task: Use partial application to create a function that fixes the first argument to console.log.
...
function logger(namespace) {
    return function() { console.log.apply(console, [namespace].concat(slice.call(arguments))) }
}
